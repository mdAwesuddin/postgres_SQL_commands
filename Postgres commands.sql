-- SELECT version(); 
-- to check the version of the PostgreSQL
...
-- ('Mercedes Benz', 'GLS4', 2014),
-- ('GMC', 'SUV', 2013)
-- this command is used to insert multiple row data
...
-- to add, delete and modify a column in exisiting table we use alter command

-- UPDATE cars
-- SET color = 'blue'
-- WHERE brand='Phantom'
-- used to modify the values in existing records in a table
-- warning: if you not use where clause then it will update all rows
...
-- UPDATE cars
-- SET color = 'white', year = 2015
-- WHERE brand = 'Mercedes Benz'
-- Update Multiple Rows

-- ALTER TABLE cars
-- ALTER COLUMN year TYPE VARCHAR(4);
-- To change the data type or size of a table column we use ALTER
...
-- DELETE FROM cars
-- WHERE brand = 'GMC';
-- To delete a specific record in the table

-- DELETE FROM cars;
-- Will delete all the records from the table

-- TRUNCATE TABLE cars;
-- We can also use truncate command to delete records from the table

-- DROP TABLE cars;
-- It is used to drop an existing table in Database
...
-- VALUES
-- ('Beverages', 'Soft drinks, coffee, tea, and ales'),
